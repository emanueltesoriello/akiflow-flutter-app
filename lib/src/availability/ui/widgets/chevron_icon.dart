...
class ChevronIcon extends StatefulWidget {
  /// Creates an [ChevronIcon] with the given padding, and a callback that is
  ...
  @override
  State<ChevronIcon> createState() => _ChevronIconState();
}

class _ChevronIconState extends State<ChevronIcon> with SingleTickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ChevronIcon oldWidget) {
