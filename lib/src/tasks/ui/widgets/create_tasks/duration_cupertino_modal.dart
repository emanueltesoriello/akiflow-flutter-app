...
class _DurationCupertinoModalState extends State<DurationCupertinoModal> {
  TimeOfDay duration = const TimeOfDay(hour: 0, minute: 0);

  @override
  void initState() {
    duration = secondsToTimeOfDay(widget.state.updatedTask.duration ?? 0);
    super.initState();
  }
              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(t.timeModal.selectDuration,
                ...
                Container(
                  ...
                  child: OutlinedButton(
                    onPressed: () {
                      ...
                      //context.read<EditTaskCubit>().setDuration(timeOfDayToSeconds(duration), fromModal: true);
