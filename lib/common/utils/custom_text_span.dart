...
///
/// A [CustomTextSpan] object can be styled using its [style] property. The style will
/// be applied to the [text] and the [children].
///
/// A [CustomTextSpan] object can just have plain text, or it can have children
/// [CustomTextSpan] objects with their own styles that (possibly only partially)
/// override the [style] of this object. If a [CustomTextSpan] has both [text] and
/// [children], then the [text] is treated as if it was an un-styled [CustomTextSpan]
/// at the start of the [children] list. Leaving the [CustomTextSpan.text] field null
/// results in the [CustomTextSpan] acting as an empty node in the [InlineSpan] tree
/// with a list of children.
///
/// To paint a [CustomTextSpan] on a [Canvas], use a [TextPainter]. To display a text
...
///
/// The [CustomTextSpan.text] will be used as the semantics label unless overridden
/// by the [CustomTextSpan.semanticsLabel] property. Any [PlaceholderSpan]s in the
/// [CustomTextSpan.children] list will separate the text before and after it into two
/// semantics nodes.
///
/// See also:
///
...
///  * [TextPainter], a class for painting [CustomTextSpan] objects on a [Canvas].
@immutable
class CustomTextSpan extends InlineSpan implements HitTestTarget, MouseTrackerAnnotation {
  /// Creates a [CustomTextSpan] with the given values.
  ///
  ...
  /// children.
  ///
  /// Modifying the list after the [CustomTextSpan] has been created is not supported
  ...
  ///
  /// [CustomTextSpan] itself does not implement hit testing or cursor changing.
  /// The object that manages the [CustomTextSpan] painting is responsible
  /// to return the [CustomTextSpan] in its hit test, as well as providing the
  /// correct mouse cursor when the [CustomTextSpan]'s mouse cursor is
  /// [MouseCursor.defer].
  ...
  /// An alternative semantics label for this [CustomTextSpan].
  ///
  ...
  ///
  /// ```dart
  /// CustomTextSpan(text: r'$$', semanticsLabel: 'Double dollars')
  /// ```
  ...
  /// [TextPainter] class to paint [CustomTextSpan] objects onto [Canvas]
  /// objects.
  @override
  void build(
    ...
    if (text != null) {
      try {
        ...
        FlutterError.reportError(FlutterErrorDetails(
          ...
          context: ErrorDescription('while building a CustomTextSpan'),
        ));
  ...
  /// Walks this [CustomTextSpan] and its descendants in pre-order and calls [visitor]
  ...
  // removed from `computeSemanticsInformation` recognizer semantic info to
  // prevent Flutter from assert it, no side effect should be expected.
  ...
  ///
  /// ```dart
  /// assert(myCustomTextSpan.debugAssertIsValid());
  /// ```
  @override
  ...
  RenderComparison compareTo(InlineSpan other) {
    ...
    final textSpan = other as CustomTextSpan;
  ...
  bool operator ==(Object other) {
    ...
    return other is CustomTextSpan &&
        other.text == text &&
  ...
  @override
  String toStringShort() => objectRuntimeType(this, 'CustomTextSpan');
