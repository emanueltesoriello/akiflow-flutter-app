...
_TimePickerHeaderFormat _buildHeaderFormat(
  ...
  _TimePickerHeaderFragment hour() {
    return _TimePickerHeaderFragment(
      ...
      widget: decoratedBox(_HourControl(fragmentContext: context), context),
    );
  }
  ...
  _TimePickerHeaderFragment minute() {
    return _TimePickerHeaderFragment(
      ...
      widget: decoratedBox(_MinuteControl(fragmentContext: context), context),
    );
  }
...
class _TimePickerHeaderLayout extends MultiChildLayoutDelegate {
  ...
  void _positionPivoted(double width, double y, Map<_TimePickerHeaderId, Size> childSizes,
  ...
  void _positionPiece(double width, double centeredAroundY, Map<_TimePickerHeaderId, Size> childSizes,
  ...
  TimeOfDay _getTimeForTheta(double theta) {
    ...
    if (widget.mode == _TimePickerMode.hour) {
      ...
      return widget.selectedTime
          .replacing(minute: (fraction * TimeOfDay.minutesPerHour).round() % TimeOfDay.minutesPerHour);
    }
  }
...
class _TimePickerDialogState extends State<_TimePickerDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    final Widget actions = CustomFlutterRoundedButtonAction(
...
///    date picker.
Future<TimeOfDay?> customShowRoundedTimePicker({
