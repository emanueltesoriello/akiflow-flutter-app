...
var extractDateAndText = function (customChrono, text, options) {
    ...
    var parseResults = customChrono.parse(text, forwardFrom, options)
...
exports.extractDateAndText = extractDateAndText;
