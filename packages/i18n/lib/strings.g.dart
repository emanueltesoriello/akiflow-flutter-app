...
class _StringsAvailabilityEn {
  ...
  String get activeManualSlots => 'Manual slots';
...
class _StringsEventEditEventEn {
  ...
  late final _StringsEventEditEventRepeatingEditModalEn repeatingEditModal =
      _StringsEventEditEventRepeatingEditModalEn._(_root);
...
class _StringsSettingsIntegrationsGmailEn {
  ...
  late final _StringsSettingsIntegrationsGmailOnMarkAsDoneEn onMarkAsDone =
      _StringsSettingsIntegrationsGmailOnMarkAsDoneEn._(_root);
  late final _StringsSettingsIntegrationsGmailToImportTaskEn toImportTask =
      _StringsSettingsIntegrationsGmailToImportTaskEn._(_root);
...
extension on _StringsEn {
  Map<String, dynamic> _buildFlatMap() {
    return <String, dynamic>{
      ...
      'settings.integrations.gmail.openYourEmailsInSuperhumanInsteadOfGmail':
          'Open your emails in superhuman instead of Gmail',
      ...
      'event.editEvent.repeatingEditModal.description':
          'Do you want to change only this occurrence or change this and all future occurrences?',
      'event.editEvent.repeatingEditModal.deleteDescription':
          'Do you want to delete only this occurrence or delete this and all future occurrences?',
      ...
      'event.editEvent.deleteModal.title': ({required Object eventName}) =>
