...
class _StringsEn {
  ...
  late final _StringsLinkedContentEn linkedContent =
      _StringsLinkedContentEn._(_root);
...
class _StringsOnboardingEn {
  ...
  String get welcomeToAkiflowSubtitle =>
      'Where your tasks and calendars\nstays together.';
  String get or => 'or';
  String get signInWithGoogle => 'Sign in with Google';
  String get continuingAcceptTermsPrivacy =>
      '<center>Continuing you accept the <a url="https://google.com">Terms and Conditions</a><br/> and the <a url="https://google.com">Privacy Policy</a> of Akiflow</center>';
}
...
class _StringsTaskEn {
  ...
  late final _StringsTaskUndoActionsEn undoActions =
      _StringsTaskUndoActionsEn._(_root);
...
class _StringsEditTaskEn {
  ...
  String everyFirstCurrentDayOfTheMonth({required Object day}) =>
      'Every first ${day} of the month';
  String everyYearOn({required Object date}) => 'Every year on ${date}';
  String get everyWeekday => 'Every weekday';
  String get custom => 'Custom';
  String get comingSoon => 'Coming soon';
  late final _StringsEditTaskRepeatingEditDialogEn repeatingEditDialog =
      _StringsEditTaskRepeatingEditDialogEn._(_root);
}
...
class _StringsLabelEn {
  ...
  late final _StringsLabelDeleteDialogEn deleteDialog =
      _StringsLabelDeleteDialogEn._(_root);
}
...
class _StringsEditTaskRepeatingEditDialogEn {
  ...
  String get description =>
      'Do you want to change only this occurrence or change this and all future occurrences?';
...
class _StringsLabelDeleteDialogEn {
  ...
  // Translations
  String title({required Object labelTitle}) =>
      'You are deleting ${labelTitle}';
  String get description =>
      'What do you want to do with the tasks assigned to this label?';
...
extension on _StringsEn {
  Map<String, dynamic> _buildFlatMap() {
    return <String, dynamic>{
      ...
      'onboarding.welcomeToAkiflowSubtitle':
          'Where your tasks and calendars\nstays together.',
      'onboarding.or': 'or',
      'onboarding.signInWithGoogle': 'Sign in with Google',
      'onboarding.continuingAcceptTermsPrivacy':
          '<center>Continuing you accept the <a url="https://google.com">Terms and Conditions</a><br/> and the <a url="https://google.com">Privacy Policy</a> of Akiflow</center>',
      'bottomBar.menu': 'Menu',
      ...
      'editTask.everyFirstCurrentDayOfTheMonth': ({required Object day}) =>
          'Every first ${day} of the month',
      'editTask.everyYearOn': ({required Object date}) =>
          'Every year on ${date}',
      ...
      'editTask.repeatingEditDialog.description':
          'Do you want to change only this occurrence or change this and all future occurrences?',
      'editTask.repeatingEditDialog.onlyThis': 'Only this task',
      'editTask.repeatingEditDialog.thisAndAllFuture':
      ...
      'label.deleteDialog.title': ({required Object labelTitle}) =>
          'You are deleting ${labelTitle}',
      'label.deleteDialog.description':
          'What do you want to do with the tasks assigned to this label?',
