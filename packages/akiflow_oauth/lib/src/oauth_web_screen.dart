...
import 'package:akiflow_oauth/src/oauth_web_view.dart';
...
class OAuthWebScreen extends StatelessWidget {
  static Future? start({
    ...
    ValueChanged<MapEntry<String, String>>? onSuccess,
  ...
  final ValueChanged<MapEntry<String, String>>? onSuccess;
  ...
  void _onSuccess(MapEntry<String, String> credentials) {
