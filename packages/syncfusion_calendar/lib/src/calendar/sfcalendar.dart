...
class SfCalendar extends StatefulWidget {
  ...
  SfCalendar({
    ...
    this.appointmentTextStyle =
        const TextStyle(color: Colors.white, fontSize: -1, fontWeight: FontWeight.w500, fontFamily: 'Roboto'),
...
class _SfCalendarState extends State<SfCalendar> with SingleTickerProviderStateMixin {
  ...
  SfCalendarThemeData _getThemeDataValue(SfCalendarThemeData calendarThemeData, ColorScheme colorScheme) {
    return calendarThemeData.copyWith(
        ...
        trailingDatesTextStyle: calendarThemeData.trailingDatesTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontSize: 13, fontFamily: 'Roboto'),
        ...
        agendaDayTextStyle: calendarThemeData.agendaDayTextStyle ??
            ...
            TextStyle(
                ...
                fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        agendaDateTextStyle: calendarThemeData.agendaDateTextStyle ??
            TextStyle(color: colorScheme.onSurface, fontSize: 18, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        todayTextStyle: calendarThemeData.todayTextStyle ??
            TextStyle(color: colorScheme.onPrimary, fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        headerTextStyle: calendarThemeData.headerTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 18, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        activeDatesTextStyle: calendarThemeData.activeDatesTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        timeTextStyle: calendarThemeData.timeTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.54), fontWeight: FontWeight.w500, fontSize: 10),
        // ignore: lines_longer_than_80_chars
        viewHeaderDateTextStyle: calendarThemeData.viewHeaderDateTextStyle ??
            TextStyle(
                ...
                fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        viewHeaderDayTextStyle: calendarThemeData.viewHeaderDayTextStyle ??
            TextStyle(
                color: colorScheme.onSurface.withOpacity(0.87),
                fontSize: 11,
                fontWeight: FontWeight.w400,
                fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        displayNameTextStyle: calendarThemeData.displayNameTextStyle ??
            TextStyle(color: colorScheme.onSurface, fontSize: 10, fontWeight: FontWeight.w500, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        weekNumberTextStyle: calendarThemeData.weekNumberTextStyle ??
            TextStyle(color: colorScheme.onSurface.withOpacity(0.87), fontSize: 13, fontFamily: 'Roboto'),
        // ignore: lines_longer_than_80_chars
        timeIndicatorTextStyle: calendarThemeData.timeIndicatorTextStyle ??
            TextStyle(color: colorScheme.primary, fontWeight: FontWeight.w500, fontSize: 10));
  }
    ...
    for (int i = 0; i < dateAppointmentKeys.length; i++) {
      ...
      widgets.add(GestureDetector(
        child: _ScheduleAppointmentView(
            ...
            content: Container(
              padding: EdgeInsets.fromLTRB(isRTL ? 0 : viewPadding, appointmentViewTopPadding, isRTL ? viewPadding : 0,
        ...
        child: Container(
            ...
            child: RepaintBoundary(
                child: headerWidget != null
                    ...
                    : CustomPaint(
                        painter: _ScheduleLabelPainter(startDate, endDate, widget.scheduleViewSettings, isMonthLabel,
                            isRTL, _locale, _useMobilePlatformUI, _calendarTheme, _localizations, _textScaleFactor),
                        size: isMonthLabel
    ...
    return GestureDetector(
      child: _ScheduleAppointmentView(
          ...
          content: Container(
            ...
            child: CustomPaint(
                painter: _ScheduleLabelPainter(currentDisplayDate, null, widget.scheduleViewSettings, false, isRTL,
                    _locale, _useMobilePlatformUI, _calendarTheme, _localizations, _textScaleFactor,
                    isDisplayDate: true),
  ...
  Widget _addDatePicker(double top, bool isRTL) {
    ...
    final TextStyle datePickerStyle =
        widget.monthViewSettings.monthCellStyle.textStyle ?? _calendarTheme.activeDatesTextStyle!;
            ...
            child: Container(
                ...
                child: SfDateRangePicker(
                  ...
                  yearCellStyle: DateRangePickerYearCellStyle(
                    ...
                    leadingDatesTextStyle: widget.monthViewSettings.monthCellStyle.leadingDatesTextStyle ??
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.isMobilePlatform || (widget.isMobilePlatform && weekNumberEnabled)) {
      final Size headerTextSize = _getTextWidgetWidth(
          ...
          style: widget.headerStyle.textStyle ?? widget.calendarTheme.headerTextStyle);
                            ...
                            child: Row(
                              ...
                              children: <Widget>[
                                ...
                                Icon(
                                  ...
                                  color: arrowColor,
                                  size: (widget.headerStyle.textStyle ?? widget.calendarTheme.headerTextStyle)!
                                          .fontSize ??
                                      14,
                                )
                              ],
...
class _ScheduleLabelPainter extends CustomPainter {
  ...
  void _addDisplayDateLabel(Canvas canvas, Size size) {
    ...
    final TextSpan span = TextSpan(
      ...
      style: scheduleViewSettings.weekHeaderSettings.weekTextStyle ?? scheduleViewSettings.placeholderTextStyle,
    );
...
class _AgendaDateTimePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (isToday) {
      final Color? todayTextStyleColor =
          todayTextStyle != null ? todayTextStyle!.color : calendarTheme.todayTextStyle!.color;
      final Color? todayTextColor =
  ...
  void _addDayLabelForMobile(Canvas canvas, Size size, double padding, TextStyle dayTextStyle, TextStyle dateTextStyle,
    ...
    TextSpan span = TextSpan(text: DateFormat(dayTextFormat, locale).format(selectedDate!), style: dayTextStyle);
    _updateTextPainter(span);
    ...
    _textPainter.paint(canvas, Offset(xPosition, isToday ? yPosition : yPosition + 5));
  }
  ...
  void _drawTodayCircle(Canvas canvas, double xPosition, double yPosition, double padding) {
    final RRect rrect = RRect.fromRectAndRadius(
        Rect.fromCircle(
          center: Offset(xPosition + (_textPainter.width / 2), yPosition + (_textPainter.height / 2)),
