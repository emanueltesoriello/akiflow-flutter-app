...
class Event extends Equatable implements Base {
  ...
  Event copyWith({
    ...
    dynamic content,
    Nullable<List<EventAtendee>?>? attendees,
    ...
    bool? hidden,
    Nullable<String?>? url,
    Nullable<String?>? meetingStatus,
    Nullable<String?>? meetingUrl,
    Nullable<String?>? meetingIcon,
    ...
    return Event(
      ...
      creatorId: creatorId == null ? this.creatorId : creatorId.value,
      organizerId: organizerId == null ? this.organizerId : organizerId.value,
      ...
      meetingStatus: meetingStatus == null ? this.meetingStatus : meetingStatus.value,
      meetingUrl: meetingUrl == null ? this.meetingUrl : meetingUrl.value,
      meetingIcon: meetingIcon == null ? this.meetingIcon : meetingIcon.value,
  ...
  static Event fromSql(Map<String?, dynamic> json) {
    ...
    event = event.copyWith(recurrence: Nullable(recurrenceList));
